<!DOCTYPE html>
  ...
  <html>
    ...
    <head>
      ...
      <title>SelectWorks.nl - Opdrachten pagina</title>

      <link rel="stylesheet" type="text/css" href="opdrachten-style.css">
...
<body>
	...
	<div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav">
			...
			<li><a href="/selectworks/index.php"><-- Terug naar Selectworks.nl</a></li>
			<li class="active"><a href="vacatures.php">Opdrachten</a></li>
